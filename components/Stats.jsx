...
const stats = [
  ...
  },
  {
    num: 3,
    suffix: "",
    text: "Standards OGC · INSPIRE · ISO 19115",
    href: "/work",
  },
];
...
const StatItem = ({ stat, index, isLast }) => {
  ...
  return (
    <Link
      ...
      style={!isLast ? { borderRight: "0.5px solid #e5e0d8" } : {}}
    >
      {/* Chiffre animé */}
      <div className="font-syne font-black transition-colors duration-200 group-hover:text-accent"
           style={{ fontSize: 28, color: "#0a0a0a", lineHeight: 1 }}>
        {isInView ? (
          <CountUp
            end={stat.num}
            suffix={stat.suffix}
      ...
      <p
        ...
        style={{ fontSize: 10, color: "#aaaaaa", maxWidth: 120 }}
      >
        {stat.text}
      </p>
    </Link>
