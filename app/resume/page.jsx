...
const experience = {
  ...
  description:
    "Conception et développement de plateformes de données scientifiques et environnementales. De l'architecture backend à l'interface utilisateur.",
  items: [
    {
      ...
      description:
        "Développement solo du portail FROST-FORMS : wizard IoT multi-étapes, catalogue de 53 instruments LoRaWAN, carte interactive et workflow de modération. Conformité OGC SensorThings, INSPIRE, ISO 19115.",
    },
    {
      ...
      description:
        "Pilotage d'un projet de digitalisation (Datamesh, méthodes agiles). Développement d'applications web.",
    },
    {
      company: "GSI Concept",
      ...
      description:
        "Développement d'applications web avec technologies frontend et backend modernes.",
    },
    {
      company: "Outlier",
    ...
    },
    {
      ...
      duration: "2020 - 2022",
      description: "Enseignement des mathématiques au niveau secondaire.",
    },
  ],
};
...
const CardLight = ({ children, highlight }) => (
  <div
    className="py-6 px-8 rounded-xl flex flex-col justify-center gap-2"
    style={{
      background: "#ffffff",
      border: highlight ? "0.5px solid #ddd6fe" : "0.5px solid #e5e0d8",
    }}
  >
    {children}
  </div>
    ...
    >
      <div className="container mx-auto">
        ...
        <div className="mb-12">
          ...
          <h1
            className="font-syne font-black text-[38px] xl:text-[52px] leading-[1.05] text-primary-dark mb-6"
          ...
          <div
            ...
            style={{ background: "#f3f0ff", color: "#7c3aed", border: "0.5px solid #ddd6fe" }}
          >
            <FaGraduationCap />
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link
              href="/assets/resume/CV_Koud-UM.pdf"
              download
              className="font-inter inline-flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-medium transition-opacity hover:opacity-80"
            ...
            <Link
              href="/assets/resume/CV_Koud_IAE.pdf"
              download
              className="font-inter inline-flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-medium transition-colors hover:bg-primary-dark/5"
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="font-syne font-bold text-2xl text-primary-dark text-center mb-10">
            Timeline
          </h2>
          <div className="relative">
            ...
            <div
              ...
              style={{ width: "0.5px", background: "#e5e0d8" }}
            />
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      ...
                      height: 10,
                      borderRadius: "50%",
                      background: item.type === "education" ? "#8b5cf6" : "#0a0a0a",
                      top: 16,
                    }}
                  />
                  ...
                  <div className={`w-5/12 ${index % 2 === 0 ? "pr-8 text-right" : "pl-8"}`}>
                    <div
                      ...
                      style={{
                        background: "#ffffff",
                        border: `0.5px solid ${item.type === "education" ? "#ddd6fe" : "#e5e0d8"}`,
                      }}
                    >
                      <div className={`flex items-center gap-2 mb-1 ${index % 2 === 0 ? "justify-end" : ""}`}>
                        <span style={{ color: item.type === "education" ? "#8b5cf6" : "#0a0a0a", fontSize: 12 }}>
                          {item.icon}
                        </span>
                        <span
                          className="font-inter text-[11px] font-medium"
                          style={{ color: item.type === "education" ? "#8b5cf6" : "#aaaaaa" }}
                        >
                          {item.year}
                        </span>
                      </div>
                      <h3 className="font-syne font-bold text-base text-primary-dark mb-0.5">
                        {item.title}
                      </h3>
                      <p className="font-inter text-xs text-muted">{item.description}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
          ...
          <div className="min-h-[70vh] w-full">
            ...
            <TabsContent value="experience" className="w-full">
              <div className="flex flex-col gap-6 text-center xl:text-left">
                <h3 className="font-syne font-bold text-2xl text-primary-dark">{experience.title}</h3>
                <p className="font-inter text-sm text-muted max-w-[600px] mx-auto xl:mx-0">
                    ...
                    {experience.items.map((item, index) => (
                      <li key={index}>
                        <CardLight>
                          ...
                          <h3 className="font-syne font-bold text-base text-primary-dark max-w-[260px] min-h-[48px] text-center lg:text-left">
                            {item.position}
                          </h3>
                          <div className="flex items-center gap-2">
                            <span className="w-1.5 h-1.5 rounded-full bg-accent shrink-0" />
                            <p className="font-inter text-sm text-muted">{item.company}</p>
                          </div>
                          {item.description && (
                            <p className="font-inter text-xs text-muted mt-1 leading-relaxed">{item.description}</p>
                          )}
                        </CardLight>
                      </li>
                    ))}
            ...
            <TabsContent value="education" className="w-full">
              <div className="flex flex-col gap-6 text-center xl:text-left">
                <h3 className="font-syne font-bold text-2xl text-primary-dark">{education.title}</h3>
                <p className="font-inter text-sm text-muted max-w-[600px] mx-auto xl:mx-0">
                ...
                <ScrollArea className="h-[420px]">
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-4 pr-2">
                    {education.items.map((item, index) => (
                      <li key={index}>
                        <CardLight highlight={item.highlight}>
                          {item.highlight && (
                            <span
                              className="font-inter text-[10px] px-2 py-0.5 rounded-full self-start"
                          ...
                          <div className="flex items-center gap-2">
                            <span className="w-1.5 h-1.5 rounded-full bg-accent shrink-0" />
                            <p className="font-inter text-sm text-muted">{item.institution}</p>
                          </div>
                          {item.skills && (
                            <p className="font-inter text-xs text-muted mt-1 leading-relaxed">{item.skills}</p>
                          )}
                        </CardLight>
                      </li>
                    ))}
            ...
            <TabsContent value="skills" className="w-full" id="skills">
              <div className="flex flex-col gap-6 text-center xl:text-left">
                <h3 className="font-syne font-bold text-2xl text-primary-dark">{skills.title}</h3>
                <p className="font-inter text-sm text-muted max-w-[600px] mx-auto xl:mx-0">
                  {skills.description}
                </p>
                <ScrollArea className="h-[420px]">
                  <ul className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 gap-4 pr-2">
                    {skills.skillList.map((skill, index) => (
                      ...
                      >
                        ...
                        <p className="font-inter text-sm font-medium text-primary-dark text-center">{skill.name}</p>
                      </li>
                    ))}
                  </ul>
                </ScrollArea>
            ...
            <TabsContent value="about-me" className="w-full">
              <div className="flex flex-col gap-6 text-center xl:text-left">
                <h3 className="font-syne font-bold text-2xl text-primary-dark">{about.title}</h3>
                <p className="font-inter text-sm text-muted max-w-[600px] mx-auto xl:mx-0">
                  {about.description}
                </p>
                <ul className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4">
                  {about.info.map((info, index) => (
                    <li
                      ...
                      style={{ background: "#ffffff", border: "0.5px solid #e5e0d8" }}
                    >
                      <span className="font-inter text-[11px] font-semibold text-accent min-w-[90px] pt-0.5 uppercase tracking-wider">
                        {info.fieldName}
                      </span>
                      <span className="font-inter text-sm text-primary-dark">{info.fieldValue}</span>
                    </li>
                  ))}
                </ul>
              </div>
