      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          ...
          <div className="w-full xl:w-[50%]">
            <Swiper
              spaceBetween={20}
              slidesPerView={1}
              className="xl:h-[350px] mb-12"
              onSlideChange={handleSlideChange}
            >
              {projects.map((proj, index) => (
                <SwiperSlide key={index} className="relative flex justify-center items-center bg-gray-900">
              ...
              <WorkSliderBtns
                ...
                btnStyles="bg-accent text-primary text-lg w-[40px] h-[40px] flex justify-center items-center rounded-full hover:bg-accent-hover"
              />
            </Swiper>
          </div>
        </div>

        {/* 🔥 Bouton pour voir plus de projets sur GitHub et GitLab 🔥 */}
        <div className="mt-12 flex justify-center">
          ...
          <Link
            ...
            target="_blank"
            className="ml-4 flex items-center gap-3 bg-accent text-primary px-6 py-3 rounded-full text-lg font-semibold hover:bg-accent-hover transition-all"
          >
